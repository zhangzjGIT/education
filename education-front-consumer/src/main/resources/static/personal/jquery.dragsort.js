		...
		this.each(function(i, cont) {
			...
			var newList = {
				...
				init: function() {
					...
					var the=this;
					$(this.container).attr("data-listidx", i).live('mousedown',the.grabItem).live("dragsort-uninit", this.uninit);
				...
				dragStart: function(e) {
					...
					$(document).live("mousemove", list.swapItems);
					$(document).live("mouseup", list.dropItem);
					if (opts.scrollContainer != window)
						$(window).live("DOMMouseScroll mousewheel", list.wheel);
				},
